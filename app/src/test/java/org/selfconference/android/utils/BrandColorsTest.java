...
public class BrandColorsTest {
    ...
    @Test
    public void firstBrandColorIsGreen() {
    ...
    @Test
    public void secondBrandColorIsOrange() {
    ...
    @Test
    public void thirdBrandColorIsPurple() {
    ...
    @Test
    public void fourthBrandColorIsRed() {
    ...
    static final class BrandColorsAssert extends AbstractAssert<BrandColorsAssert, Pair<Integer, Integer>> {
        ...
        public BrandColorsAssert hasPrimaryColor(int colorResId) {
            ...
            Assertions.assertThat(actual.first)
                    .overridingErrorMessage("Expected primary color was <%s> but actual was <%s>", toHexString(expectedColor), toHexString(actual.first))
        ...
        public BrandColorsAssert hasSecondaryColor(int colorResId) {
            ...
            final int expectedColor = getColor(colorResId);
            Assertions.assertThat(actual.second)
                    .overridingErrorMessage("Expected secondary color was <%s> but actual was <%s>", toHexString(expectedColor), toHexString(actual.second))
                    .isEqualTo(expectedColor);
