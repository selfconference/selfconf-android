 ...
 * This allows the {@link FeedbackFragment} dialog to be dismissed while this API call is still in progress.
 * <p/>
 * If there is a successful POST to {@code /sessions/{sessionId}/feedbacks}, this service will post a
 * {@link SuccessfulFeedbackSubmission} event to broadcast the successful completion of this call to
...
public final class SubmitFeedbackIntentService extends IntentService {
    ...
    @Override protected void onHandleIntent(Intent intent) {
        ...
        final Response response = api.submitFeedback(session, feedback)
                .toBlocking()
                .single();
